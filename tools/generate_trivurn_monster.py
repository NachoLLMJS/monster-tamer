...
SOURCE = ROOT / "tools" / "sources" / "trivurn-tron-idle-generated.png"
OUTPUT = ROOT / "assets" / "images" / "monster-tamer" / "monsters" / "trivurn-battle-idle.png"
FRAME_SIZE = 256
FRAME_COUNT = 4
...
def main() -> None:
    ...
    for left, right in columns:
        ...
        if bbox is None:
            raise RuntimeError("Generated Trivurn frame is empty")
