...
const STORY_QUESTS = Object.freeze([
  ...
  },
  {
    id: 'enter-forest',
    number: 7,
    title: 'Entra en el Bosque Esmeralda',
    description: 'Sigue el camino hacia el norte y cruza la entrada del bosque.',
    requiresDefeatedNpcs: [9],
    completesOnArea: 'forest_1',
  },
  {
    id: 'break-rock-gate',
    number: 8,
    title: 'Rompe la barrera de rocas',
    description: 'En la parte norte del bosque, mira hacia las rocas y pulsa ESPACIO.',
    requiresArea: 'forest_1',
