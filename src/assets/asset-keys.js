...
export const BATTLE_ASSET_KEYS = Object.freeze({
  ...
  TRAINER_YOUTH_BOY_GREEN_RIVAL: 'TRAINER_YOUTH_BOY_GREEN_RIVAL',
});
...
export const WORLD_ASSET_KEYS = Object.freeze({
  ...
  MAIN_1_BACKGROUND_CLEARED: 'MAIN_1_BACKGROUND_CLEARED',
  ...
  BEACH: 'BEACH',
  GRASS: 'GRASS',
  AC_FAN_SPIN: 'AC_FAN_SPIN',
  FOREST_1_BACKGROUND: 'FOREST_1_BACKGROUND',
  FOREST_1_BACKGROUND_CLEARED: 'FOREST_1_BACKGROUND_CLEARED',
  FOREST_1_FOREGROUND: 'FOREST_1_FOREGROUND',
  FOREST_1_LEVEL: 'FOREST_1_LEVEL',
  PLAZA_1_BACKGROUND: 'PLAZA_1_BACKGROUND',
  PLAZA_1_LEVEL: 'PLAZA_1_LEVEL',
  PLAZA_GUILD_HALL: 'PLAZA_GUILD_HALL',
  PLAZA_INN: 'PLAZA_INN',
  PLAZA_MAGIC_SHOP: 'PLAZA_MAGIC_SHOP',
  PLAZA_WORKSHOP: 'PLAZA_WORKSHOP',
...
export const CHARACTER_ASSET_KEYS = Object.freeze({
  ...
  NPC: 'NPC',
  MOTHER: 'MOTHER',
  INTRO_GIRL: 'INTRO_GIRL',
  BNB_RAPPER: 'BNB_RAPPER',
  BINANCE_PROFESSOR: 'BINANCE_PROFESSOR',
  WATERFRONT_MAN: 'WATERFRONT_MAN',
  ITEM_MERCHANT_NPC: 'ITEM_MERCHANT_NPC',
  FOREST_RANGER_NPC: 'FOREST_RANGER_NPC',
  FIELD_NURSE_NPC: 'FIELD_NURSE_NPC',
  GREEN_RIVAL_TRAINER: 'GREEN_RIVAL_TRAINER',
  INN_HEALER_NPC: 'INN_HEALER_NPC',
  ROBINHOOD_JR_TRAINER: 'ROBINHOOD_JR_TRAINER',
  GREEN_PIRATE_JR_TRAINER: 'GREEN_PIRATE_JR_TRAINER',
});
